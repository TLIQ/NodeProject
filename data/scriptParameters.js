export const scriptParametersCalls = {
    "_id": "5e79d853511cbc291b81c2d0",
    "parameters": {
        "sTI8v": {
            "aggregation": "avg",
            "description": "",
...
export const scriptParametersChat = {
    "_id": "62d173534f5c89e0811ce191",
    "parameters": {
        "script": {
            "name": "Скрипт, %",
            "short_name": "СКР",
        ...
        "Dwpww": {
            "aggregation": "avg",
            "description": "silence_max",
            "form": {
                "name": "simple",
                "screen_name": "Простой"
            },
            "is_negative": true,
            "name": "Максимальное время паузы",
            "reference": "meta.silence_max",
            "role": {
                "name": "",
                "screen_name": ""
        ...
        "31rXi": {
            "aggregation": "avg",
            "description": "chat_duration",
            "form": {
                "name": "simple",
                "screen_name": "Простой"
            },
            "is_negative": true,
            "name": "Продолжительность диалога",
        ...
        "blgiA": {
            "aggregation": "avg",
            "description": "chat_duration сброс",
            "form": {
                "name": "simple",
                "screen_name": "Простой"
            },
